...
import { Shield, Check, ArrowRight, Info, AlertCircle } from 'lucide-react';
...
const ALL_SERVICES = [
  { id: "child-protection", title: "Child Protection", note: "Real-time school tracking & SOS buttons." },
  { id: "elderly-care", title: "Elderly Care", note: "Automatic fall detection & vitals monitoring." },
  { id: "fire-prevention", title: "Fire Prevention", note: "Smart heat, gas & thermal leak detection." },
  { id: "property-security", title: "Property Security", note: "Smart locks & perimeter breach alerts." },
  { id: "asset-protection", title: "Asset Protection", note: "High-precision GPS tracking for gear." },
  { id: "neighborhood-surveillance", title: "Neighborhood Surveillance", note: "Community watch node integration." }
];
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground font-light max-w-2xl mx-auto">
              Select the SafeRwanda protocols you want active in your security roadmap. You can add more later.
            </p>
          </div>
            ...
            <CardContent className="pt-6 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground italic">You are one step away from Kigali's smartest security network.</p>
                </div>
              </div>
              <Button 
              ...
              >
                Proceed to Account Creation <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
            </CardContent>
          </Card>
        </div>

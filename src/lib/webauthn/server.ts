...
export const webauthnConfig = {
  ...
  // Default to studio environment ID if env var is missing
  ...
  origin: process.env.WEBAUTHN_ORIGIN || 'https://6000-firebase-studio-1781599696400.cluster-64pjnskmlbaxowh5lzq6i7v4ra.cloudworkstations.dev',
};
